...
def test_bump_version():
    ...
    assert not os.path.exists(datastore.get_metadata_file_path("DATASET_A", "0.0.0"))
    assert os.path.exists(datastore.get_metadata_file_path("DATASET_A", "0.1.0"))

    # Redundant metadata file DATASET_B__0_0_0.json - unchanged
    assert os.path.exists(datastore.get_metadata_file_path("DATASET_B", "0.0.0"))

    # Data file DATASET_A__0_0.parquet - change in name
    assert not os.path.exists(datastore.get_data_file_path("DATASET_A", "0.0.0"))
    assert os.path.exists(datastore.get_data_file_path("DATASET_A", "0.1.0"))

    # Data dir DATASET_B__0_0 - unchanged
    assert os.path.exists(datastore.get_data_file_path("DATASET_B", "0.0.0"))
...
def test_bump_version_twice():
    ...
    # Redundant metadata file DATASET_A__0_1_0.json - unchanged
    assert os.path.exists(datastore.get_metadata_file_path("DATASET_A", "0.1.0"))
    assert not os.path.exists(datastore.get_metadata_file_path("DATASET_A", "0.2.0"))

    # Redundant metadata file DATASET_B__0_0_0.json - change in name
    assert not os.path.exists(datastore.get_metadata_file_path("DATASET_B", "0.0.0"))
    assert os.path.exists(datastore.get_metadata_file_path("DATASET_B", "0.2.0"))

    # Data file DATASET_A__0_1.parquet - unchanged
    assert os.path.exists(datastore.get_data_file_path("DATASET_A", "0.1.0"))
    assert not os.path.exists(datastore.get_data_file_path("DATASET_A", "0.2.0"))

    # Data dir DATASET_B__0_0 - change in name
    assert not os.path.exists(datastore.get_data_file_path("DATASET_B", "0.0.0"))
    assert os.path.exists(datastore.get_data_file_path("DATASET_B", "0.2.0"))
    ...
    # data_versions__0_1_0.json - unchanged
    data_versions = datastore.get_data_versions("0.1.0")
    assert len(data_versions) == 1
    assert data_versions["DATASET_A"] == "DATASET_A__0_1.parquet"
